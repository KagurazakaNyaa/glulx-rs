...
- [x] 273 library tests and 6 CLI tests pass; 6 performance tests remain ignored for manual measurement. Domain-specific matrices and edge-case coverage are in the validation record.
